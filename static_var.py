...
class Analog_val(object):
    ...
    def printer(self):
        print(colored(str(self.name) + " " + str(self.val) + " " + str(self.log) + " " + str(self.data1) + " " + str(
            self.data2) + " "
                      + str(self.data3) + " " + str(self.data4) + " " + str(self.data5) + " " + str(self.data6) + " ",
                      'blue', ))
...
def loadA():
    a = datetime.datetime.now()
    global SS1, SS2, SS3, SSS1, SSS2, SSS3
    try:
        s1 = 777
        ...
        SSS2 = SS2.data4
        SSS3 = SS3.data4
        return SS1, SS2, SS3, SSS1, SSS2, SSS3
